...
func (r *ApplicationVolumeReplicationReconciler) processPausedSubscription(
	...
	ready := r.isManagedClusterReadyForFailback(subscription, newHomeCluster)
	r.Log.Info(newHomeCluster, "is ready for failback:", ready)
...
func (r *ApplicationVolumeReplicationReconciler) isVRGReadyForFailover(
	vrg *ramendrv1alpha1.VolumeReplicationGroup) bool {
	ready := true
